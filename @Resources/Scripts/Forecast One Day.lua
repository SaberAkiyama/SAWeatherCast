...
function matchTomorrow()
	...
	SKIN:Bang('!SetOption MeterTonightTemperature MeasureName "MeasureNextDayTemperatureF"')
	...
	SKIN:Bang('!SetOption MeterTonightWindCardinalSpeed MeasureName2 "MeasureNextDayWindSpeedMph"')
	...
	SKIN:Bang('!SetOption MeterMoonrise MeasureName "MeasureOneDaySunrise12H"')
	...
	SKIN:Bang('!SetOption MeterMoonset MeasureName "MeasureOneDaySunset12H"')
